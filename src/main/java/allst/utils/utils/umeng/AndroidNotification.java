 ...
 *
 */
public abstract class AndroidNotification extends AbstractUmengNotification {
    ...
    protected static final HashSet<String> BODY_KEYS = new HashSet<>(Arrays.asList(new String[]{
            "ticker", "title", "text", "builder_id", "icon", "largeIcon", "img", "play_vibrate", "play_lights", "play_sound", "type",
            "sound", "after_open", "url", "activity", "custom", "timestamp"}));
